...
/*
 * PanelsTabs.java requires the following file:
 *    images/wavy.gif
 */
public class PanelsTabs extends JPanel {
    public PanelsTabs() {
    ...
    protected static ImageIcon createImageIcon(String path,
                                               String description) {
        java.net.URL imgURL = PanelsTabs.class.getResource(path);
        if (imgURL != null) {
    ...
    private static void createAndShowGUI() {
        ...
        JFrame frame = new JFrame("PanelsTabs");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
 
        //Create and set up the content pane.
        PanelsTabs newContentPane = new PanelsTabs();
